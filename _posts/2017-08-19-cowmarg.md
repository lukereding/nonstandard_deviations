...
Below I download the data directly from [Dryad](http://datadryad.org/resource/doi:10.5061/dryad.jf0r0), perform some basic cleaning of the data, then c        				reate the plot:
...
This is a pretty simple scatterplot with the points colored according to whether each bird species has rod-shaped or derived melanosomes.
